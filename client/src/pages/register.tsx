    ...
    <div className="min-h-screen w-full flex items-center justify-center bg-background p-4">
      <div className="w-full max-w-md space-y-8 animate-in slide-in-from-bottom-4 duration-700">
        ...
        <div className="px-2 pb-4">
          <p className="text-[10px] sm:text-[11px] text-muted-foreground/70 leading-relaxed text-center">
          ...
          <p className="mt-1 text-[10px] sm:text-[11px] text-muted-foreground/70 leading-relaxed text-center">
